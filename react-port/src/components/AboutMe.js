  ...
  return <div className="container py-5">
      ...
      <div className="row"> 
        ...
        <div className="col-lg-6 col-xm-12">
            ...
            <br></br>
            Proficient and knowledgeable in JavaScript, CSS, Web-APIs, Express, SQL, NoSQL, PWA React, Bootstrap with a focus on mobile-first design and development for a rounded user experience. <br></br>
            <br></br>
